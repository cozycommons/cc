...
| Referee scoring | Referee mode prioritizes one-handed entry. Common actions are Point, Table hit, FIFA, and Miss; rare outcomes stay under More. The server derives team and score. | Main | [`LiveGame.test.jsx`](../frontend/src/dice/pages/LiveGame.test.jsx), [`test_dice_live_service.py`](../backend/tests/test_dice_live_service.py) |
